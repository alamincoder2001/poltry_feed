					...
					<div class="row">
						<div class="col-md-5 col-xs-12">
							<div class="form-group clearfix" style="margin-bottom: 8px;">
								...
								<div class="col-xs-8">
									<input type="radio" name="salesType" value="retail" id="retail" v-model="sales.salesType" v-on:change="onSalesTypeChange"> <label for="retail">Retail</label> &nbsp;
									<input type="radio" name="salesType" value="wholesale" id="wholesale" v-model="sales.salesType" v-on:change="onSalesTypeChange"> <label for="wholesale">Wholesale</label>
								</div>
							</div>
							<div class="form-group">
						...
						<div class="col-md-5 col-xs-12">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-xs-9">
										<v-select v-bind:options="batches" v-model="selectedBatch" label="Batch_No" @input="onChangeBatch"></v-select>
									</div>
								</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							...
							<th style="width:15%;color:#000;">Batch No.</th>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-6">
													<input type="number" id="discount" class="form-control" v-model="sales.discount" v-on:input="calculateTotal" readonly />
												</div>
