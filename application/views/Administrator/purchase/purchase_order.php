						...
						<div class="col-md-6 col-xs-12">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-xs-4">
										<input type="text" id="purchaseRate" name="purchaseRate" class="form-control" autocomplete="off" placeholder="Pur. Rate" v-model="selectedProduct.Product_Purchase_Rate" v-on:input="productTotal" required />
									</div>

									<label class="col-xs-1 control-label no-padding-left"> Qty </label>
									<div class="col-xs-3 no-padding-left">
										<input type="text" step="0.01" id="quantity" autocomplete="off" class="form-control" placeholder="Quantity" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" required />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-8">
										<input type="text" id="batch_no" @input="batchCheck" class="form-control" v-model="selectedProduct.batch_no" />
									</div>
								</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr>
							...
							<th style="width:13%;color:#000;">Batch No.</th>
							...
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;">
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-1 no-padding-left" style="margin-top: 3px;"> % </div>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-6 control-label">Due</label>
...
<script>
	...
	new Vue({
		...
		methods: {
			...
			batchCheck(event){
				axios.post('/check_batch', {batchNo: this.selectedProduct.batch_no}).then(res => {
					if (res.data.status) {
						alert(res.data.msg);
						event.target.value = '';
					}
			...
			addToCart() {
				...
				if (this.selectedProduct.batch_no == '' || this.selectedProduct.batch_no == undefined) {
