								...
								<table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
									...
									<tr>
										<td>
											<div class="form-group">
												<div class="col-xs-6">
													<input type="button" style="width: 100%;" class="btn btn-default" value="Save" v-on:click="saveQuotation">
												</div>
												<div class="col-xs-6">
													<input type="button" style="width: 100%;" class="btn btn-info" value="New" v-on:click="window.location = '/quotation'">
												</div>
											</div>
										</td>
									</tr>
